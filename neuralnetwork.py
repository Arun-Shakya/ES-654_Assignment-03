...
Original file is located at
    https://colab.research.google.com/drive/1BYGEYrqssHqQ21wfHPa9aIKlYxaRfE79
"""
...
class NNetwork:
    ...
    def __init__(self,X,y,hidden=[3,4,5],typ=[ 'sigmoid' ,'sigmoid','sigmoid']):
        self.hidden=hidden
        self.typ=typ
        n_out=1
        tot=2+len(hidden)
...
y_train=y[:train]
y_test=y[train:]
MLP = NNetwork(X_train,y_train,[4,4,4], ['sigmoid','sigmoid','sigmoid'])
